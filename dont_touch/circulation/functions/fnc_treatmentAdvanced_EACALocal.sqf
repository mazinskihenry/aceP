...
[_target, "activity", LSTRING(push_log), [[_medic] call ace_common_fnc_getName, "EACA"]] call ace_medical_treatment_fnc_addToLog;
[_target, "EACA", 5, 120, 0, 0, 0] call ace_medical_status_fnc_addMedicationAdjustment;
...
[{
    ...
    private _count = [_target, "EACA"] call ace_medical_status_fnc_getMedicationCount;
