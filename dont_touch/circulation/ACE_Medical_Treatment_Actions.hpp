class ACE_Medical_Treatment_Actions {
    ...
    class EACA: Carbonate {
        ...
        condition = QUOTE(_patient getVariable [ARR_2(QQGVAR(IVplaced), true)]) && QFUNC(removeIV);
        patientStateCondition = 0;
        callbackSuccess = QUOTE([ARR_2(_player, _patient)] call FUNC(treatmentAdvanced_EACA));
    };
    ...
    class ClosedReduction: CheckFracture {
        ...
        patientStateCondition = 0;
        callbackStart = QUOTE([ARR_3(_medic, _patient, _bodyPart)] call FUNC(subSplint));
    ...
    class Debridement: BasicBandage {
        ...
        treatmentTime = 8;
        items[] = {"kat_scalpel"};
        condition = QUOTE([ARR_4(_medic, _patient, _bodyPart, 0)] call FUNC(debridementCheck));
        consumeItem = 0;
        patientStateCondition = 0;
        callbackSuccess = QUOTE([ARR_4(_medic, _patient, _bodyPart, 1)] call FUNC(debridementCheck));
    };
